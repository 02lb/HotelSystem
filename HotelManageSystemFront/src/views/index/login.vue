...
<!--          <img :src="MailIcon" class="left-icon">-->用户账号：
          <div class="input-view">
            <input  v-model="pageData.loginForm.username" type="text" class="input">
            <p class="err-view">
            </p>
          </div>
          <!---->
        ...
        <div class="common-input">
<!--          <img :src="PwdIcon" class="left-icon">-->用户密码：
          <div class="input-view">
            <input  v-model="pageData.loginForm.password" type="password" class="input">
            <p class="err-view">
            </p>
          </div>
        </div>
...
import LogoIcon from '/@/assets/images/sysu.png';
